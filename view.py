...
def usuario():
    ...
    if usuarios:  # Verifica se há usuários na lista
        mensagem = f'O usuário {usuarios[0][1]} foi encontrado'
    else:
        mensagem = 'Nenhum usuário encontrado'

    return jsonify(mensagem=mensagem, usuarios=usuarios_dic)
...
def usuario_post():
    ...
    if cursor.fetchone():
        return jsonify('Email do usuário já cadastrado')
